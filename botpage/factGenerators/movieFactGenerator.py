...
"favoriteMovieFact": ["!SHE! cries(( every time)) while watching it", "!SHE! watched it ((about ))!SMALLINT! times(( as a kid))", "it has !HER! favorite actor", "!SHE! watched it at her first date", "!SHE! loves the ending", "!SHE! watched it after passing her exam", "it was !HER! father's favorite movie", "it was the only movie that played at !HER! cinema"],
